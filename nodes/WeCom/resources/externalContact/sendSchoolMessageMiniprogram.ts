...
export const sendSchoolMessageMiniprogramDescription: INodeProperties[] = [
	{
		...
		hint: '必填。小程序appid，必须是关联到企业的小程序应用',
	},
	{
		displayName: '标题',
		name: 'title',
		...
		default: '',
		placeholder: '欢迎报名夏令营',
		description: '可选。小程序消息标题，最多64个字节，超过会自动截断（支持ID转译）。',
		hint: '可选。小程序消息标题，最多64个字节，超过会自动截断，支持id转译',
	},
	{
		...
		hint: '必填。小程序消息封面的mediaid，封面图建议尺寸为520*416',
	},
	{
		displayName: '页面路径',
		name: 'pagepath',
