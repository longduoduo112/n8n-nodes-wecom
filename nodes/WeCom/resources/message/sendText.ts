...
export const sendTextDescription: INodeProperties[] = [
	...
	},
	{
		...
		description:
			'可选。表示是否是保密消息，默认否。开启后消息不可转发、复制等。<a href="https://developer.work.weixin.qq.com/document/path/90236#文本消息" target="_blank">官方文档</a>',
	},
	{
		...
		description: '可选。表示是否开启ID转译，默认否。开启后，消息中的userid会转译为@对应成员。<a href="https://developer.work.weixin.qq.com/document/path/90236#文本消息" target="_blank">官方文档</a>',
	},
	{
		...
		description:
			'可选。表示是否开启重复消息检查，默认否。开启后在时间间隔内相同内容的消息不会重复发送。<a href="https://developer.work.weixin.qq.com/document/path/90236#文本消息" target="_blank">官方文档</a>',
	},
	{
