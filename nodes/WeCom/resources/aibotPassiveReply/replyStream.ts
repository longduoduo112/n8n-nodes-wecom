...
export const replyStreamDescription: INodeProperties[] = [
	{
		...
		hint: '可选。自定义的唯一id，首次回复时必须设置。后续回调会根据这个id来获取最新的流式消息',
	},
	{
		displayName: '是否结束',
		name: 'finish',
	...
	},
	{
		...
		description: '流式消息内容',
		hint: '可选。流式消息内容，最长不超过20480个字节，必须是utf8编码。支持markdown格式。特殊的，第一次回复内容为"1"，第二次回复"123"，则此时消息展示内容"123"',
	},
	{
		displayName: '图片列表',
		name: 'msg_item',
		...
		hint: '可选。图文混排消息列表，目前仅支持图片类型。特殊的，目前image的消息类型仅当finish=true，即流式消息结束的最后一次回复中设置。最多支持设置10个',
		options: [
			{
				name: 'image',
				displayName: '图片',
