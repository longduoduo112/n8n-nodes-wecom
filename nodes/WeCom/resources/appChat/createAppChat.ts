...
export const createAppChatDescription: INodeProperties[] = [
	{
		...
		default: '',
		placeholder: '请输入群聊名称',
		hint: '可选。群聊名称，最多50个utf8字符，超过将自动截断',
		description:
	...
	},
	{
		...
		placeholder: 'userid',
		description:
			'可选。指定群主的 ID。如果不指定，系统会随机从userlist中选一人作为群主。<a href="https://developer.work.weixin.qq.com/document/path/90245" target="_blank">官方文档</a>',
		hint: '可选。指定群主的ID，必须是userlist的成员之一。如果不填，系统会随机从userlist中选一人作为群主',
	},
	{
		displayName: '成员列表',
		name: 'userlist',
		...
		hint: '必填。群成员ID列表，用逗号分隔。至少2人，至多2000人（含应用）',
	},
	{
		displayName: '指定群聊ID',
		name: 'chatid',
		...
		hint: '可选。群聊的唯一标志，不能与已有的群重复。字符串类型，最长32个字符，只允许字符0-9及字母a-zA-Z。如果不填，系统会随机生成群id',
	},
];
